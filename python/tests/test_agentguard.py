import pytest
from agentguard.taint import TaintEngine
from agentguard.scanner import Scanner, Pattern
from agentguard.vault import InMemoryVaultAdapter
from agentguard.security import PromptShield, AuditLogger
...
class TestAgentGuard:
    ...
    async def test_validate_prompt_blocks(self):
        guard = AgentGuard(prompt_shield_enabled=True)
